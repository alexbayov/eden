...
**Статус:** M3-D performance pass implemented; initial bundle budget automated, browser E2E/performance and manual mobile QA unverified, 18 августа 2026.
...
- CI workflows run `lint`, `typecheck`, `test`, `build`, and `analyze:budget`.
...
- Commands: `npm run lint`, `npm run typecheck`, `npm run test`, `npm run build`, `npm run analyze:budget`.
