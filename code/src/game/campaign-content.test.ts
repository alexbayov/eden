...
describe('data-driven M2 catalog contracts', () => {
  const mission = { contentVersion: CONTENT_VERSION, kind: 'missions', entries: [{ id: 'near-perimeter', zoneId: 'near-perimeter', name: 'Signal', objective: 'secure', arenaId: 'dusty-perimeter', difficulty: 0, rewardId: 'near-perimeter-clear' }] }
