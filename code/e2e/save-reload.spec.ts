...
test.describe("W4-05 schema upgrade and W4-01 level progress across a reload", () => {
  ...
  test("continues a save created before the upgrade, raising it through v5 and v6 to v7 with a derived level", async ({ page }) => {
    ...
    /* W7-01: a v4 payload is now three hops from current (v4 -> v5 -> v6 -> v7), and each stage is validated by
